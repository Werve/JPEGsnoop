...
void CimgDecode::SetPreviewZoom(bool bInc, bool bDec, bool bSet, unsigned nVal)
{
    ...
    switch (m_nZoomMode)
    {
    case PRV_ZOOM_12: m_nZoom = 0.125;
        break;
    case PRV_ZOOM_25: m_nZoom = 0.25;
        break;
    case PRV_ZOOM_50: m_nZoom = 0.5;
        break;
    case PRV_ZOOM_100: m_nZoom = 1.0;
        break;
    case PRV_ZOOM_150: m_nZoom = 1.5;
        break;
    case PRV_ZOOM_200: m_nZoom = 2.0;
        break;
    case PRV_ZOOM_300: m_nZoom = 3.0;
        break;
    case PRV_ZOOM_400: m_nZoom = 4.0;
        break;
    case PRV_ZOOM_800: m_nZoom = 8.0;
        break;
    default: m_nZoom = 1.0;
        break;
    }
                            ...
                            CFont* pFont, CSize& szNewScrollSize)
{
    ...
    if (m_bDibTempReady)
    {
        ...
        else
        {
            ...
            {
            case PREVIEW_RGB: strTitle += _T("RGB");
                break;
            case PREVIEW_YCC: strTitle += _T("YCC");
                break;
            case PREVIEW_R: strTitle += _T("R");
                break;
            case PREVIEW_G: strTitle += _T("G");
                break;
            case PREVIEW_B: strTitle += _T("B");
                break;
            case PREVIEW_Y: strTitle += _T("Y");
                break;
            case PREVIEW_CB: strTitle += _T("Cb");
                break;
            case PREVIEW_CR: strTitle += _T("Cr");
                break;
            default: strTitle += _T("???");
                break;
            }
        ...
        case PRV_ZOOM_100: strTitle += _T(" @ 100% (1:1)");
            break;
        case PRV_ZOOM_150: strTitle += _T(" @ 150% (3:2)");
            break;
        case PRV_ZOOM_200: strTitle += _T(" @ 200% (2:1)");
            break;
        case PRV_ZOOM_300: strTitle += _T(" @ 300% (3:1)");
            break;
        case PRV_ZOOM_400: strTitle += _T(" @ 400% (4:1)");
            break;
        case PRV_ZOOM_800: strTitle += _T(" @ 800% (8:1)");
            break;
        default: strTitle += _T("");
            break;
        }
