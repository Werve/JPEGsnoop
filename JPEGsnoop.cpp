...
BEGIN_MESSAGE_MAP(CJPEGsnoopApp, CWinApp)
    ON_COMMAND(ID_APP_ABOUT, &CJPEGsnoopApp::OnAppAbout)
    ON_COMMAND(ID_FILE_NEW, &CWinApp::OnFileNew)
    ON_COMMAND(ID_FILE_OPEN, &CJPEGsnoopApp::MyOnFileOpen)
    ON_COMMAND(ID_FILE_PRINT_SETUP, &CWinApp::OnFilePrintSetup)
    ON_COMMAND(ID_OPTIONS_DHTEXPAND, &CJPEGsnoopApp::OnOptionsDhtexpand)
    ON_COMMAND(ID_OPTIONS_MAKERNOTES, &CJPEGsnoopApp::OnOptionsMakernotes)
    ON_COMMAND(ID_OPTIONS_CONFIGURATION, &CJPEGsnoopApp::OnOptionsConfiguration)
    ON_COMMAND(ID_OPTIONS_CHECKFORUPDATES, &CJPEGsnoopApp::OnOptionsCheckforupdates)
    ON_COMMAND(ID_OPTIONS_SIGNATURESEARCH, &CJPEGsnoopApp::OnOptionsSignaturesearch)
    ON_COMMAND(ID_TOOLS_MANAGELOCALDB, &CJPEGsnoopApp::OnToolsManagelocaldb)
    ON_COMMAND(ID_SCANSEGMENT_DECODEIMAGE, &CJPEGsnoopApp::OnScansegmentDecodeimage)
    ON_COMMAND(ID_SCANSEGMENT_FULLIDCT, &CJPEGsnoopApp::OnScansegmentFullidct)
    ON_COMMAND(ID_SCANSEGMENT_HISTOGRAMY, &CJPEGsnoopApp::OnScansegmentHistogramy)
    ON_COMMAND(ID_SCANSEGMENT_DUMP, &CJPEGsnoopApp::OnScansegmentDump)
    ON_UPDATE_COMMAND_UI(ID_OPTIONS_DHTEXPAND, &CJPEGsnoopApp::OnUpdateOptionsDhtexpand)
    ON_UPDATE_COMMAND_UI(ID_OPTIONS_MAKERNOTES, &CJPEGsnoopApp::OnUpdateOptionsMakernotes)
    ON_UPDATE_COMMAND_UI(ID_OPTIONS_SIGNATURESEARCH, &CJPEGsnoopApp::OnUpdateOptionsSignaturesearch)
    ON_UPDATE_COMMAND_UI(ID_SCANSEGMENT_DECODEIMAGE, &CJPEGsnoopApp::OnUpdateScansegmentDecodeimage)
    ON_UPDATE_COMMAND_UI(ID_SCANSEGMENT_FULLIDCT, &CJPEGsnoopApp::OnUpdateScansegmentFullidct)
    ON_UPDATE_COMMAND_UI(ID_SCANSEGMENT_HISTOGRAMY, &CJPEGsnoopApp::OnUpdateScansegmentHistogramy)
    ON_UPDATE_COMMAND_UI(ID_SCANSEGMENT_DUMP, &CJPEGsnoopApp::OnUpdateScansegmentDump)
    ON_COMMAND(ID_SCANSEGMENT_NOIDCT, &CJPEGsnoopApp::OnScansegmentNoidct)
    ON_UPDATE_COMMAND_UI(ID_SCANSEGMENT_NOIDCT, &CJPEGsnoopApp::OnUpdateScansegmentNoidct)
    ON_COMMAND(ID_SCANSEGMENT_HISTOGRAM, &CJPEGsnoopApp::OnScansegmentHistogram)
    ON_UPDATE_COMMAND_UI(ID_SCANSEGMENT_HISTOGRAM, &CJPEGsnoopApp::OnUpdateScansegmentHistogram)
    ON_COMMAND(ID_OPTIONS_HIDEUKNOWNEXIFTAGS, &CJPEGsnoopApp::OnOptionsHideuknownexiftags)
    ON_UPDATE_COMMAND_UI(ID_OPTIONS_HIDEUKNOWNEXIFTAGS, &CJPEGsnoopApp::OnUpdateOptionsHideuknownexiftags)
    ON_COMMAND(ID_FILE_BATCHPROCESS, &CJPEGsnoopApp::OnFileBatchprocess)
